...
Section "Installation of ${PRODUCT_NAME}" SecAppFiles
  ...
  File "Production\lib\eclipselink-2.3.0.jar"
  ...
  File "Production\lib\javax.persistence-2.0.jar"
  ...
  File "Production\lib\org.eclipse.persistence.jpa.jpql_1.0.0.jar"
  ...
  File "Production\lib\PointBoxWebProxy.jar"
  ...
  File "Production\regular_pricing_x86.dll"
  File "Production\regular_pricing_x64.dll"
  File "Production\auto_pricing_x86.dll"
  File "Production\auto_pricing_x64.dll"
...
Section Uninstall
  ...
  Delete "$INSTDIR\regular_pricing_x64.dll"
  Delete "$INSTDIR\regular_pricing_x86.dll"
  Delete "$INSTDIR\auto_pricing_x64.dll"
  Delete "$INSTDIR\auto_pricing_x86.dll"
  ...
  Delete "$INSTDIR\lib\eclipselink-2.3.0.jar"
  ...
  Delete "$INSTDIR\lib\javax.persistence-2.0.jar"
  ...
  Delete "$INSTDIR\lib\org.eclipse.persistence.jpa.jpql_1.0.0.jar"
  ...
  Delete "$INSTDIR\lib\PointBoxWebProxy.jar"
