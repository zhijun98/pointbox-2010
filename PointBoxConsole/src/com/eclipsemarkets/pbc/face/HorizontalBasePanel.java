 ...
 * @author Zhijun Zhang
 */
public class HorizontalBasePanel extends javax.swing.JPanel {
    private static final long serialVersionUID = 1L;

    private final IPbcFace face;

    public static HorizontalBasePanel createHorizontalBasePanel(final IPbcFace face){
        return new HorizontalBasePanel(face);
    }
    
    /** Creates new form VerticalBasePanel
     * @param face
     */
    private HorizontalBasePanel(final IPbcFace face)
    {
        initComponents();
        this.face = face;
        initializeTalker();
    ...
    private void initComponents() {
        ...
        jSecondarySplitPane.setRightComponent(jViewerZone);

        jMessagingZone.setName("jMessagingZone"); // NOI18N
        jMessagingZone.setLayout(new java.awt.BorderLayout());
        jSecondarySplitPane.setTopComponent(jMessagingZone);
