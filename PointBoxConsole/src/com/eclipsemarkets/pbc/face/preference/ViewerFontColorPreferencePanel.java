 ...
 */
public class ViewerFontColorPreferencePanel extends PreferencePanel{

    public ViewerFontColorPreferencePanel(IPbcFace face) {
        super(face);
    ...
    private void initializeSingleViewerSettingsPanesHelper(String viewerTabUniqueName, String viewerTabTitle){
            ...
            ViewerTableFontColorSettingsPanel baseViewerTableSettingsPanel = new ViewerTableFontColorSettingsPanel(face, viewerTabUniqueName);
