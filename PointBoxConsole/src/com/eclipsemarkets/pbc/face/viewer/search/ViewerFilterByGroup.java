 ...
 */
class ViewerFilterByGroup extends ViewerFilterCriteria implements IViewerFilterByGroup {

    private ArrayList<String> criteriaValues;

    ViewerFilterByGroup(ArrayList<String> criteriaValues) {
    ...
    public List<PbcFilterPropertySettings> constructPbcFilterPropertySettingsList() {
        if (aPbcFilterPropertySettingsList == null){
            ...
            aPbcFilterPropertySettings.setPropertyKey(FilterPropertyKey.jGroup_SelectedName.toString());
     ...
     */
    @Override
    public ArrayList<String> getCriteriaGroupValues() {
        return criteriaValues;
    }

    @Override
    public ArrayList<String> getSearchGroupValueList() {
